            ...
            <div className='HeroBG'>
              ...
              <div className="container profileName">
                ...
                <div className="social-links">
                  <a href="https://github.com/Hareesvar7"><GitHub /> </a>
                  <a href="https://www.linkedin.com/in/hareesvar7/"><LinkedIn /> </a>
                  <a href="mailto:hareesvar1@gmail.com"><EmailIcon /></a>
                </div>
            ...
            <div className="container">
              ...
              <div >
                <div className="text-center content">
                  <div></div>
                  <h3>Web Developer &amp; MERN Developer</h3>
                  <br />
                  ...
                  <div data-aos="zoom-in" className='contentId my-5 d-flex align-item-center justify-content-around'>
                    ...
                    <ul>
                      <li><strong>Locality:</strong><p>Pollachi, India</p></li>
                      <li><strong>Email:</strong><p>hareesvar1@gmail.com</p></li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="row skills-content">
                <div className="col-lg-6">
                  ...
                  <div className="progress">
                    ...
                    <div className="progress-bar-wrap">
                      <LinearProgress variant='determinate' color='inherit' value={70} />
                    </div>
                  </div>
                  <div className="progress">
                  ...
                  <div className="progress">
                    <span className="skill">sql & Mongo DB <i className="val">75%</i></span>
                    <div className="progress-bar-wrap">
                ...
                <div className="col-lg-6">
                  ...
                  <div className="progress">
                    <span className="skill">Bootstrap & Tailwind <i className="val">90%</i></span>
                    <LinearProgress variant='determinate' color='inherit' value={90} />
                  </div>
                  <div className="progress">
                    <span className="skill">Material UI <i className="val">60%</i></span>
                ...
                <div className="row">
                  <div className="col-lg-6">
                    ...
                    <div className="resume-item">
                      ...
                      <h5>2017 - 2019</h5>
                      <p><em>NBNS National School, Annur , Tamil Nadu, India  </em></p>
                  ...
                  <div className="col-lg-6">
                    ...
                    <div className="resume-item">
                      <h4>Hotel Website</h4>
                      <p><em><a href=' https://651b11953bce8238f556ce6a--stellar-sopapillas-27504f.netlify.app/'> https://651b11953bce8238f556ce6a--stellar-sopapillas-27504f.netlify.app/</a></em></p>
                      <ul>
                        <li>The moto of project is to use Bottstrap frame work for the project.</li>
                      </ul>
                    </div>
                    <div className="resume-item">
                      <h4>Snake Game</h4>
                    ...
                    <div className="resume-item">
                      ...
                      <p><em><a href='https://hareesvar7.github.io/Travel_Task/'>https://hareesvar7.github.io/Travel_Task/</a></em></p>
                      <ul>
                        <li>Project for an travel website using HTML,CSS,JS</li>
                      </ul>
                    </div>
                    <div className="resume-item">
                      <h4>UG Projects</h4>
